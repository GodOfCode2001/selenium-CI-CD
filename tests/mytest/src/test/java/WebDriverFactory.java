...
public class WebDriverFactory {
     ...
     * @return Remote WebDriver that connects to Selenium Grid
     */
    public static WebDriver createRemoteDriver() {
        String gridUrl = System.getProperty("selenium.grid.url", "http://chrome:4444");
        ...
        try {
            ...
            System.err.println("Failed to create remote WebDriver: " + e.getMessage());
            e.printStackTrace();
            throw new RuntimeException("Could not create RemoteWebDriver", e);
        }
    }
    /**
    ...
    public static WebDriver createDriver() {
        // check if WebDriver should be created remotely
